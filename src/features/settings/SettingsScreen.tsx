...
export const SettingsScreen = ({ workspaceId, payload }: SettingsScreenProps) => {
  ...
  const savePreferences = () => {
    toast({
      ...
      description: payload.source === "backend" ? "Configuracoes aplicadas." : "Salvas em modo mock.",
      variant: "success"
    });
  };
            ...
            <Button
              ...
              onClick={async () => {
                if (payload.source === "mock") {
                  toast({ title: "Modo mock", description: "Nao ha persistencia de stages.", variant: "warning" });
                  return;
                }
