...
export interface CRMDataSourceMeta {
  source: "backend" | "mock";
}

export type DashboardPayload = DashboardData & CRMDataSourceMeta;
...
export type PipelinePayload = { stages: LeadStage[]; columns: PipelineColumn[] } & CRMDataSourceMeta;
...
export type SettingsPayload = CRMSettingsData & CRMDataSourceMeta;
